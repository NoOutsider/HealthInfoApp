...
const FemaleOutPatientDataTable= () => {
  ...
  //};
    ...
    const renderFemaleOutPatientDataTable = (dataList) => {
    return (
  ...
  let contents = !state.loading ? (
    <p>
      <em>Loading...</em>
          ...
          renderFemaleOutPatientDataTable(state.dataList)
  );
...
export default FemaleOutPatientDataTable;
