    ...
    public class FemaleTenAgeRepository
    {
        ...
        public List<FemaleTenAge> allFemaleTenAgeDataList()
        {
            ...
            while (dataReader.Read())
            {
                ...
                femaleTenAge.나이10대미만 = dataReader.GetInt32(2);
                femaleTenAge.나이10대 = dataReader.GetInt32(3);
                femaleTenAge.나이20대 = dataReader.GetInt32(4);
                femaleTenAge.나이30대 = dataReader.GetInt32(5);
                femaleTenAge.나이40대 = dataReader.GetInt32(6);
                femaleTenAge.나이50대 = dataReader.GetInt32(7);
                femaleTenAge.나이60대 = dataReader.GetInt32(8);
                femaleTenAge.나이70대 = dataReader.GetInt32(9);
                femaleTenAge.나이80대이상 = dataReader.GetInt32(10);
