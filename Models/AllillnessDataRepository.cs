    ...
    public class AllillnessDataRepository
    {
        ...
        public Dictionary<string, List<Object>> UpdateChartData(AllillnessData allillnessData)
        {
            ...
            else if (allillnessData.menuName == "성별/연령5세구간별")
            {
                ...
                cmd.CommandText = $"select 진료년월, { allillnessData.age_5} from { allillnessData.menuName} where 진료년월 between to_date('{allillnessData.startDate}','yyyy/mm/dd') and to_date('{allillnessData.endDate}','yyyy/mm//dd') and state = '{allillnessData.item}' and 질병명 = '{allillnessData.illnessName}' and 성별 = '{allillnessData.gender}' order by 진료년월";
            }
            else
            {
